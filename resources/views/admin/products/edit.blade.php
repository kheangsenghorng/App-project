                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <input class="custom-control-input" type="checkbox" id="track_qty" name="track_qty" value="Yes" {{ ($product->track_qty == 'Yes' ) ? 'checked' : '' }} checked>
...
<script>
  ...
  $.ajax({
    ...
    success: function(response) {
      $("button[type=submit]").prop('disabled', false); // Enable submit button after response
...
$("#productForm").submit(function(event){
  ...
  $.ajax({
    url: '{{ route("products.update",$product->id) }}',// Replace with the actual URL
    type: 'put',
    data: formArray,
    dataType: 'json',
    success: function(response){ 
      ...
      if (response['status'] == true) {
        ...
        // Handle successful product creation (e.g., redirect)
      } else {
    ...
    error: function(jqXHR, exception) {
      console.error("Something Went Wrong:", jqXHR.statusText, exception);
...
$("#category").change(function() {
  ...
  $.ajax({
    url: '{{ route("product-subcategories.index") }}',  // Adjust route generation syntax if needed
    type: 'get',
