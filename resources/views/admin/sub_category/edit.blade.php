                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option {{ ($subCategory->category_id == 1) ?  'selected': '' }} value="1">Active</option> 
                                    <option {{ ($subCategory->category_id == 0) ? 'selected': '' }} value="0">Block</option>
                                </select>
                                <p></p>
                            </div>
                        </div>
...
<script>
    $("#subCategoryForm").submit(function(event) {
        ...
        var formData = $("#subCategoryForm").serializeArray(); // Get form data
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Handle successful creation of category
            ...
            error: function(jqXHR, exception) {
                console.error("Error creating category:", jqXHR.statusText, exception);
